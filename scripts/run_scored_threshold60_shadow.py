...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run threshold-60 scored candidate in shadow mode")
    ...
    try:
        ...
        print(f"Threshold-60 experiment already running: {exc}", file=sys.stderr)
        return 2
