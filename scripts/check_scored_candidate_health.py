...
def main() -> int:
    parser = argparse.ArgumentParser(description="Safe scored-candidate shadow health")
    ...
    print(json.dumps({"scored_candidate": {
        "status": "initialized" if state.last_candle is not None and rows else "not_initialized",
